...
LOGGER_ID = int(getenv("-1002588311865", ""))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/8092821983rishu/JioSaavn.git",
)
...
SUPPORT_CHAT = getenv("SUPPORT_CHAT", https://t.me/ganasupport")
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://files.catbox.moe/wy2v33.jpg"
)
PING_IMG_URL = getenv(
    "PING_IMG_URL", "https://files.catbox.moe/wy2v33.jpg"
)
